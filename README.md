...
## Introduction
One study conducted in 2019 by De Filippis et al., which investigated human gut microbomes of Italians using shotgun metagenomics, found that differing dietary habits can actually affect the presence and profile , especially for one prevalent species, *Prevotella copri*.  They  this species (De Filippis et al., 2019), revealing how diet can affect diversity at even the most specific levels of taxonomy.  Studies such as these are useful for revealing , though it is also important that the composition and abundance of other taxa within the diversity should also be investigated to understand how they function together as a whole ().  This taxonomic analysis seeks to expand on the significance of these connections, by applying different classification and diversity pipelines to compare how the abundances and diversity of certain microbiotic taxa in the human gut metagenomes differ across dietary patterns.  It will also attempt to explain how the presence (and/or dominance) of certain species contribute to essential biological functions and processes associated with the different types of foods consumed for each habit.
