...
Continuing in R (v4.5.2), all BIOM reports of abundance tables from Bracken were imported into the working environment with the *phyloseq* package (v1.54.2) (McMurdie & Holmes, 2013).  Alpha and beta diversity measures were both calculated using functions from the *vegan* package (v2.7-3) (Oksanen et al., 2026).  For alpha diversity, the Shannon and Simpson index were used to .  Meanwhile,  
